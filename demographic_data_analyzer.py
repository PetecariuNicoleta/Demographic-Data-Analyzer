...
def calculate_demographic_data(print_data=True):
    ...
    # Define the conditions for advanced education
    ...
    # Calculate the number of people among min-hours workers who earn more than 50K
    num_min_workers_rich = num_min_workers[num_min_workers['salary'] == '>50K'].shape[0]

    # Calculate the total number of people who work the minimum hours
    total_min_hours_workers = num_min_workers.shape[0]

    # Calculate the percentage
    rich_percentage = round(num_min_workers_rich / total_min_hours_workers * 100, 1)
    ...
    rich_perc = (rich_counts / country_counts) * 100

    # Find the country with the highest percentage of people earning >50K
    highest_earning_country = rich_perc.idxmax()
    highest_earning_country_percentage = round(rich_perc.max(), 1)
